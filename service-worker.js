...
const CACHE_NAME = "bolivia-2026-v4";
const APP_SHELL = ["./","./index.html","./manifest.webmanifest","./css/styles.css","./js/data.js","./js/maps.js","./js/api.js","./js/app.js","./assets/logo-pldf-com-fundo.png","./assets/foto-perfil.jpg","./assets/aviao.png","./assets/icon-192.png","./assets/icon-512.png"];
